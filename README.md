![Logo](https://raw.githubusercontent.com/BALMUZDAQ-STUDIO/Balmuzdaq-logos/refs/heads/main/Balmuzdaq_white.png)
...
- **Interactive Solar System**: Explore the solar system with visual representations of planets and asteroids.
...
- **React**: Main framework used to develop the web application.
...
1. Clone the repository:
    ...
    ```bash
    git clone https://github.com/BALMUZDAQ-STUDIO/NASA-Hack.git
    cd NASA-Hack
    ```
...
1. Open a browser and navigate to http://localhost:3000 after running the app.
2. Interact with the solar system by clicking on planets for detailed information.
3. Explore the educational features and celestial data.

## Key Files

- `App.js`: Main logic for rendering the Orrery and handling interactivity.
- `index.jsx`: Main logic of the solar system view.
- `ArComponent.jsx`: AR view logic.
