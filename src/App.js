...
return (
	<div style={{height: '100%', width: '100%', backgroundColor: 'black'}}>
		...
		<div style={{display: "flex", zIndex: 2, flexDirection: 'column'}}>
			...
			<MyButton style={{marginLeft: "148px", marginTop: "80px"}}> Start now</MyButton>
		</div>
		...
		<div style={{zIndex: 2, marginTop: '200px', marginLeft: "128px"}}>
			...
			<div style={{display: "flex", flexDirection: "row", marginTop: "50px"}}>
				<h3 style={{width: "515px"}}>Welcome to Orerry by Balmuzdaq Studio. Here we used modern technologies
					such as Three.js, React and NASA resources. Thanks to this, we were able to display all the objects
		...
		<div style={{alignItems: "center", justifyContent: "center", width: "100wh", textAlign: "center"}}>
			...
			<div style={{display: "flex", justifyContent: "space-between", alignItems: "center", flexDirection:"row",margin:"0px 128px"}}>
				<MemberCard name="Akhmedov Daler" logo={require("./assets/images/BALMUZDAQ_LOGO__v2.png")} role="UX/UI designer"/>
				<MemberCard name="Akhmedov Daler" logo={require("./assets/images/BALMUZDAQ_LOGO__v2.png")} role="UX/UI designer"/>
				<MemberCard name="Akhmedov Daler" logo={require("./assets/images/BALMUZDAQ_LOGO__v2.png")} role="UX/UI designer"/>

			</div>
			<div style={{display: "flex", justifyContent: "space-between", alignItems: "center", flexDirection:"row",marginBottom:"100px",margin:"50px 128px"}}>
			<MemberCard name="Akhmedov Daler" logo={require("./assets/images/BALMUZDAQ_LOGO__v2.png")} role="UX/UI designer"/>
			<MemberCard name="Akhmedov Daler" logo={require("./assets/images/BALMUZDAQ_LOGO__v2.png")} role="UX/UI designer"/>
			<MemberCard name="Akhmedov Daler" logo={require("./assets/images/BALMUZDAQ_LOGO__v2.png")} role="UX/UI designer"/>
			</div>
		...
		<div style={{
			...
			<div style={{display: "flex", flexDirection:"column",justifyContent: "space-between", alignItems: 'center',marginTop:10}}>
			...
			<div style={{display: "flex", flexDirection:"column", alignItems: 'start', justifyContent:'start',marginTop:10}}>
			...
			<div></div>
			<a  ><MyButton children="Return" style={{width: 200, height: 75, borderRadius: "25px", fontSize: "30px",marginTop:20}} onClick={() => {scrollToTop()}}/></a>
		</div>
